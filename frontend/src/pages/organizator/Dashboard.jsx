...
export default function OrganizerDashboard() {
  ...
  return (
    <div className="p-6 md:p-8">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Organizer Dashboard</h1>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <div className="mt-2 flex items-center justify-between">
            <p className="font-semibold text-gray-900 dark:text-slate-100">Manage Tournaments</p>
        ...
        >
          <p className="text-sm text-gray-500 dark:text-slate-400">Quick Link</p>
          <div className="mt-2 flex items-center justify-between">
            <p className="font-semibold text-gray-900 dark:text-slate-100">Manage Matches</p>
        ...
        >
          <p className="text-sm text-gray-500 dark:text-slate-400">Quick Link</p>
          <div className="mt-2 flex items-center justify-between">
            <p className="font-semibold text-gray-900 dark:text-slate-100">Manage Teams</p>

...
export default function OrganizerMatches() {
  ...
  if (error) {
    return (
      <div className="rounded-xl border border-gray-100 bg-white p-6 text-sm text-red-600 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:text-red-400">
        Error: {error}
      </div>
    );
  }
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label className="flex flex-col gap-2">
          ...
          <select
            ...
            className={getFieldClassName(formErrors.turneu_id)}
            required
          >
        ...
        <label className="flex flex-col gap-2">
          ...
          <select
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.fusha_id)}
          >
        ...
        <label className="flex flex-col gap-2">
          ...
          <select
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.ekipi_shtepiak_id)}
            required
          >
        ...
        <label className="flex flex-col gap-2">
          ...
          <select
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.ekipi_mysafir_id)}
            required
          >
        ...
        <label className="flex flex-col gap-2">
          ...
          <input
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.data_ndeshjes)}
            required
          />
        ...
        <label className="flex flex-col gap-2">
          ...
          <input
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.ora_fillimit)}
          />
        ...
        <label className="flex flex-col gap-2">
          ...
          <select
            ...
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.statusi)}
          >
        ...
        <label className="flex flex-col gap-2">
          ...
          <input
            ...
            value={formData.faza}
            onChange={handleInputChange}
            className={getFieldClassName(formErrors.faza)}
    ...
    <div className="space-y-6 text-gray-900 dark:text-slate-100">
      ...
      <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <input
          ...
          className="mb-4 w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 transition focus:outline-none focus:ring-2 focus:ring-green-500 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:placeholder:text-slate-400"
        />
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredMatches.length === 0 ? (
                <tr>
                  <td
                    colSpan="8"
                    className="px-4 py-8 text-center text-gray-600 dark:bg-slate-900 dark:text-slate-400"
                  >
                ...
                filteredMatches.map((item) => (
                  <tr
                    key={item.id}
                    className="bg-white transition-colors hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800/60"
                  >
      ...
      {showCreateModal && (
        ...
        >
          <div
            className="w-full max-w-3xl rounded-xl border border-transparent bg-white p-8 shadow-2xl dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
      ...
      {showDeleteModal && selectedMatch && (
        ...
        >
          <div
            className="w-full max-w-md rounded-xl border border-transparent bg-white p-8 shadow-2xl dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
            onClick={(e) => e.stopPropagation()}
          >

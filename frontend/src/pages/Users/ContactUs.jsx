          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className={`w-full bg-[#00A63E]/5 border rounded-lg px-4 py-3 text-white/40 placeholder:text-white/40 placeholder:text-sm focus:outline-none focus:border-green-600 transition ${errors.emri ? "border-red-500" : "border-white/20"}`}
              />
              {errors.emri && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-[#00A63E]/5 border rounded-lg px-4 py-3 text-white/40 placeholder:text-white/40 placeholder:text-sm focus:outline-none focus:border-green-600 transition ${errors.email ? "border-red-500" : "border-white/20"}`}
              />
              {errors.email && (
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                className={`w-full bg-[#00A63E]/5 border rounded-lg px-4 py-3 text-white/40 placeholder:text-white/40 placeholder:text-sm focus:outline-none focus:border-green-600 transition resize-none ${errors.mesazhi ? "border-red-500" : "border-white/20"}`}
              ></textarea>
              ...
              <div className="mt-2 flex items-start justify-between">
                ...
                <div className="ml-auto text-xs text-white/50 mt-1">

...
// Renders the global footer with brand info and helpful navigation links.
const Footer = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
              Elevate your game with our comprehensive tournament management
              system. Organize events, track live scores, and manage teams
              effortlessly.
            </p>
            {/* Social Icons */}
            <div className="flex gap-6">
              <a
                href="https://github.com/Erik-Jashari/Sistem-per-Menaxhimin-e-Turneut-Sportiv"
                target="_blank"

// Displays a placeholder table animation while data is being fetched.
              ...
              <thead className="bg-gray-800 dark:bg-slate-800">
                <tr>
                  <th className="px-6 py-4">
                    <div className="h-4 w-8 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="h-4 w-32 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="h-4 w-24 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="h-4 w-32 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="h-4 w-12 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="h-4 w-32 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                  <th className="px-6 py-4">
                    <div className="mx-auto h-4 w-20 rounded bg-gray-600 dark:bg-slate-600"></div>
                  </th>
                </tr>
              </thead>
                ...
                {[...Array(5)].map((_, index) => (
                  <tr key={index} className="bg-white dark:bg-slate-900">
                    <td className="px-6 py-4">
                      <div className="h-4 w-10 rounded bg-gray-200 dark:bg-slate-700"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 w-40 rounded bg-gray-200 dark:bg-slate-700"></div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="h-4 w-8 rounded bg-gray-200 dark:bg-slate-700"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 w-32 rounded bg-gray-200 dark:bg-slate-700"></div>
                    </td>
